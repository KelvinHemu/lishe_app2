...
class BudgetPreferencePage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BudgetPreferencePage> createState() => _BudgetPreferencePageState();
}
...
class _BudgetPreferencePageState extends ConsumerState<BudgetPreferencePage> {
  ...
  bool get _isValid => _selectedBudgetOption != null || 
                  ...
                  children: [
                    ...
                    ..._budgetOptions.entries.map((entry) {
                      ...
                      return _buildBudgetOption(
                        ...
                        isSelected: _selectedBudgetOption == key && !_isCustomBudget,
                        onTap: () {
                          setState(() {
                    ...
                    onPressed: _isValid
                      ? () {
                          ...
                          if (_isCustomBudget) {
                            ...
                            final option = _budgetOptions[_selectedBudgetOption]!;
                            budgetAmount = option['amount'].toString().replaceAll(',', '').replaceAll('+', '');
                          }
